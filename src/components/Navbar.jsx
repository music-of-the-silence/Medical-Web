...
const Navbar = () => {
    ...
    return (
        <div className='fixed w-full z-10 text-white'>
            <div>
                <div className='flex flex-row justify-between items-center p-3 md:px-16 px-5 bg-backgroundColor shadow-[rgba(0,_0,_0,_0.24)_0px_3px_10px]'>
                    ...
                    <div className='hidden lg:flex'>
                        <button className=' btn bg-brightColor text-black px-4 py-2 rounded-md hover:bg-hoverColor transition duration-300 ease-in-out' onClick={openForm}>
                            Contact Us
                        </button>
                    </div>
                ...
                <div className={`${menu ? "translate-x-0" : "translate-x-full"} lg:hidden flex flex-col absolute bg-backgroundColor text-white left-0 top-30 text-xl text-center pt-8 pb-4 gap-8 w-full h-fit transition-transform duration-500 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_10px]`}>
